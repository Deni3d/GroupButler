return {
	bot_api_key = "306137439:AAEIGAFOeCkW2mFplPDoZRqx7Pf_yk4HHgs", --Please add your bot api key here!
	cmd = '^[/!#]',
	allowed_updates = {"message", "edited_message", "callback_query"},
	db = 2, --default redis db: 0
	superadmins = {255103487},
	log = {
		chat = -1001100345192, --Your log chat, where your bot must be added!
		admin = 255103487, --The admin.
		stats = nil
	},
	...
	channel = '@Deni3d_Project', --channel username with the '@'
	source_code = 'https://github.com/RememberTheAir/GroupButler/tree/beta',
	help_groups_link = 'telegram.me/Deni3d_Project',
	plugins = {
